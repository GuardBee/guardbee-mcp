...
export async function startServer() {
    ...
    server.tool("scan_text", "Scan a text string or code snippet for exposed secrets and API keys", {
    ...
    server.tool("scan_file", "Scan a single file for exposed secrets and API keys", {
    ...
    server.tool("scan_directory", "Recursively scan a directory for exposed secrets and API keys. Automatically skips node_modules, .git, dist, and binary files.", {
    ...
    server.tool("list_patterns", "List all secret patterns that the scanner can detect", {}, async () => {
